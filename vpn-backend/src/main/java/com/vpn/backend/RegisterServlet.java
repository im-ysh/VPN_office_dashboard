...
public class RegisterServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DBUtil.getConnection()) {
            String sql = "INSERT INTO vpn_users (username, password, role, email) VALUES (?, ?, ?, ?)";
            ...
            if (rowsInserted > 0) {
            	   ...
            	   // Insert audit log
                DBUtil.insertAuditLog("admin", "REGISTER", "vpn_users", "New user registered: " + username);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("application/json");
        PrintWriter out = response.getWriter();
        out.print("{\"status\":\"success\",\"message\":\"GET request working for RegisterServlet\"}");
    }
}
